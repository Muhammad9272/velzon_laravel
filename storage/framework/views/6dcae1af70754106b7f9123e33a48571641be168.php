...
<script src="<?php echo e(URL::asset('assets/js/plugins.min.js')); ?>"></script>
 ...
 <script src="<?php echo e(asset('common_assets/bootstrap-toastr/toastr.min.js')); ?>" type="text/javascript"></script>
 
<script src="<?php echo e(URL::asset('assets/js/custom.js')); ?>"></script>
<?php echo $__env->yieldContent('script'); ?>
<?php echo $__env->yieldContent('script-bottom'); ?>
<?php /**PATH C:\xampp\htdocs\Projects\Velzon Admin Dashboard\resources\views/admin/layouts/vendor-scripts.blade.php ENDPATH**/ ?>