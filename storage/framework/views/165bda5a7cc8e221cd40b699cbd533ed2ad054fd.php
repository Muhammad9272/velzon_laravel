...
<section class="ts-hero text-white">
    ...
    <img class="ts-hero__bottom-img" src="<?php echo e(asset('front/assets/images/curved_SVG_section.svg')); ?>" alt="..." />
</section>
...
<div class="ts-products text-center">
    <div class="container">
        <div class="row row-cols-lg-3 gap-4 gap-lg-0 mb-5">
            <div>
                <img class="rounded-3 w-100 mb-4" src="<?php echo e(asset('front/assets/images/image-placeholder.png')); ?>" alt="..." />
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Projects\Velzon Admin Dashboard\resources\views/front/index.blade.php ENDPATH**/ ?>