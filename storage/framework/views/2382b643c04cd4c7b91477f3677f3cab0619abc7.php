<!doctype html >
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>"  data-layout="vertical" data-topbar="dark" data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable" data-layout-mode="light" data-layout-width="fluid" data-layout-position="scrollable" data-layout-style="default">

<head>
    <meta charset="utf-8" />
    <title><?php echo $__env->yieldContent('title'); ?>| <?php echo e($gs->name); ?> - User Dashboard </title>
    <?php if($gs->ngrok==1): ?>
...
<?php /**PATH C:\xampp\htdocs\Projects\Velzon Admin Dashboard\resources\views/user/layouts/master.blade.php ENDPATH**/ ?>