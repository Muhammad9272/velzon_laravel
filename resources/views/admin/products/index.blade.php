...
@slot('li_1') <a href="{{ route('admin.product.index') }}"> Listings</a> @endslot
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header end-t-end">
                ...
                <a href="{{ route('admin.product.create') }}" class="btn btn-primary waves-effect waves-light">Add Listing</a>
            </div>
            <div class="card-body">
