...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1')
              <a href="{{ route('admin.product.import.create') }}"> Import Data Files </a>
        @endslot
        @slot('title')
            Import
        @endslot
            ...
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    ...
                    <div class="flex-shrink-0">
                       <a href="{{asset('assets/listing-csv-format.csv')}}" class="btn btn-success" > 
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <form action="{{ route('admin.product.import.store') }}" enctype="multipart/form-data" method="post" >
                            @csrf
                            <div class="row gy-4">
