            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPagesUsers">
                        <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.users.subscribed.index') }}" class="nav-link"> Subscribed Users
                                </a>
                            </li>
                             <li class="nav-item">
                                <a href="{{ route('admin.users.transactions.index') }}" class="nav-link">  User Transactions
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('admin.subplan.index') }}" class="nav-link">Add Subscriptions</a>
                            </li>
                           
                            <li class="nav-item">
                                <a href="{{ route('admin.subfeature.index') }}" class="nav-link"> Subscription Features
                                </a>
                            </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="sidebarListingPages">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('admin.product.index') }}" class="nav-link">Listing</a>
                            </li>
                           
                            <li class="nav-item">
                                <a href="{{ route('admin.product.import.create') }}" class="nav-link">Import Listing</a>
                            </li>
                        </ul>
                    </div>
                </li>
