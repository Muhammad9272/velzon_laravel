...
@slot('li_1') <a href="{{ route('user.product.index') }}"> Listings</a> @endslot
@slot('title')Listings @endslot
@endcomponent
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header end-t-end">
                ...
                <a href="{{ route('user.product.create') }}" class="btn btn-primary waves-effect waves-light">Add Listing</a>
            </div>
            <div class="card-body">
...
{{-- DATA TABLE --}}
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('user.product.datatables') }}',
               columns: [
                        // { data: 'id', name: 'id'},
