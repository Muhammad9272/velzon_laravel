...
@section('css')
<link href="{{asset('front/thirdparty/plyr/plyr.css')}}" rel="stylesheet" />
<link rel="stylesheet" href="{{asset('front/styles/register.css')}}" />
...
<div class="container">
    ...
    <div class="form-wizard">
        <div class="row">
            <div class="col-md-6 m-auto text-center">
                ...
                <a href="{{ route('user.register') }}" class="tab-btn active">Register</a>
    ...
    <form action="{{ route('user.register.submit') }}" method="post" class="ts-contact-form rounded-3 mb-10">
        @csrf
        ...
        <p class="fw-bold text-medium-gray">
            Already registered ?
            <a class="text-decoration-none text-white" href="{{ route('user.login') }}">
                Login now.</a>
        </p>
    </form>
</div>
